...
{
    bool taken;
    taken = listaPht[lsb(br.target, a)].previsao(bht[lsb(br.target, a)].conteudo);
...
{
    listaPht[lsb(br.target, a)].atualiza(bht[lsb(br.target, a)].conteudo, br.taken);
    bht[lsb(br.target, a)].atualiza(br.taken);
}
