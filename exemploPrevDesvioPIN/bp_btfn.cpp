 ...
 * This is a backwards taken, forwards not taken branch (BTFN) predictor with
 * a last branch target target predictor.
 */
...
void BP::init()
{
    ...
    */
    ...
    br_trace << "BTFN Branch Predictor!" << endl;
}
...
Prediction BP::predict(EntInfo br)
{
    ...
    //cout << std::setprecision(30) << target << endl;
