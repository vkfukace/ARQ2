...
// struct Parametros{
//     unsigned int a, k, m, i;
//     char *b;

//     Parametros( char *bp, int ap, int kp, int mp, int ip){
//         b = bp;
//         a = ap;
//         k = kp;
//         m = mp;
...
int main(int argc, char** argv)
{
    ...
    // while ((opt = getopt(argc, argv, "b:a:k:m:i:h")) != -1)
    // {
    //     switch (opt)
    //     {
    //         case 'b':
    ...
    //         break;
    //         default:
    //             fprintf(stderr, "Uso: %s -b [gag|gap|gas|sag|...] -k [num. bits da BHR] -a [num. LSB do endereco] \n", argv[0]);
    //             fprintf(stderr, "-m [num. MSB do endereço para o PHT] -i [num. MSB do endereço para o BHR]\n");
    //             exit(EXIT_FAILURE);
    //     }
    // }
